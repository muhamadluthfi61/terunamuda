    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              ...
              if(mysqli_num_rows($querytoko)>0){
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <a href="#" class="btn btn-primary btn-md">View All</a>
          ...
          <!-- Perpustakaan -->
          <div class="card my-4">
            <h5 class="card-header">Status Buku</h5>
            <div class="card-body">

                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      Buku Favorit
                      <span class="badge badge-primary badge-pill">Matematika</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      Buku Baru
                      <span class="badge badge-primary badge-pill">Novel:Dylan</span>
                    </li>
